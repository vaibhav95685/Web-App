...
function apiFailureToast(message) {
  toast.error(message ? message : 'apiConstant.API_FAILURE',{toastId:"msg",allowHtml:true});
}

function apiSuccessToast(msg) {
  toast.success(msg ? msg : 'apiConstant.API_SUCCESS',{toastId:"msg",allowHtml:true},);
}
function clearWaitingQueue(id){
